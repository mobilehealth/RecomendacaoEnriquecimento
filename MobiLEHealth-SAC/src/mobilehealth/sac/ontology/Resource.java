...
import mobilehealth.sac.augmentation.LanguageIdentifierImplLanguageDetection;
...
public class Resource {
	...
	public void setText(String text) {
		...
		if (!text.isEmpty()) {
			LanguageIdentifier languageIndentifier = new LanguageIdentifierImplLanguageDetection();
